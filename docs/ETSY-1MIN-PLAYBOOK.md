# micro:bit Playground → Etsy 1-Minute Demo Playbook
...
- [ ] BBC micro:bit V2 powered on, showing the **X** icon *(if not → re-flash `makecode.ts`)*
...
- Use the listing **title** to echo the video's first words. If you say *"Your micro:bit becomes a playground"*, the listing title starts with *"micro:bit Playground — BLE Control Panel…"*.
...
**Title (140 chars max):**
```
micro:bit Playground — BLE Control Panel for Teachers & Kids · Sensors · Servos · Live Graph · 3D Models · No Install · Chrome / Edge
```

**160-char short description:**
```
Browser-based BLE control panel for the BBC micro:bit V2. Sensors, servos, live graphs, 3D models, and a GamePad — all from Chrome. No install, no account.
```
