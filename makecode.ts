/**
 * =========================================================
 *  micro:bit Playground – BLE Firmware (V3)
 * =========================================================
 *
 * UART over Bluetooth LE — full telemetry & control
 *
 * TELEMETRY (micro:bit → browser, every 100–200ms):
 *   TEMP:<°C>              ACC:<x>,<y>,<z>
 *   LIGHT:<0-255>          COMPASS:<0-360>
 *   SOUND:<0-255>          BTN:A/B/P0/P1/P2/LOGO:<0|1>
 *
 * COMMANDS (browser → micro:bit):
 *   TEXT:<string>           Show scrolling text on LED
 *   LM:<hex10>             Set 5×5 LED matrix
 ...
 *   GRAPH:<label>:<value>  (generated by simulate loop)
 *
 * PIN CONFLICT GUARDS:
 ...
 *
 * TAB:<name>  → tracks active browser tab
 * ========================================================= 
 */
