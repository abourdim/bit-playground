# Marketing Asset Guide — micro:bit Playground
...
**Where:** Paste into `bit-playground/index.html` or the hosted live-demo
page (`abourdim.github.io/bit-playground`). Nothing else to do.
...
**Where:**
- Own GitHub repo like `github.com/abourdim/bit-playground-companion`
- Listed in the Etsy description: "MakeCode extension published — search bit-playground-companion"
...
| `#tab=senses&lang=fr` | Sensors tab in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/bit-playground/#tab=board3d"
