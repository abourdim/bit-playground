...
TEMPLATES_BY_LANG.ar = {
  ...
  maker: {
    ...
    subtitles: [
      ...
      `رسم Chart.js · نماذج Three.js · مصدر makecode.ts مُرفق`,
...
TEMPLATES_BY_LANG.fr = {
  ...
  kid: {
    ...
    subtitles: [
      `Capteurs, servos, modèles 3D. Sans install. Sans compte.`,
  ...
  maker: {
    ...
    subtitles: [
      ...
      `Graphique Chart.js · modèles Three.js · source makecode.ts inclus`,
