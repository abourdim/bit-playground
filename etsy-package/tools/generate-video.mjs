...
const SCENES = [
  { id: 1, dur: 3,  type: 'title',  text: 'micro:bit\\nPlayground',                     subtitle: 'Your micro:bit becomes a playground' },
  { id: 2, dur: 7,  type: 'image',  src: 'pair-connect-on.png',        effect: 'zoom-in' },
  { id: 3, dur: 10, type: 'image',  src: 'pair-3d-tilted.png',         effect: 'pan-right' },
  { id: 4, dur: 10, type: 'image',  src: 'screenshot-motors-live.png', effect: 'zoom-in' },
  { id: 5, dur: 10, type: 'image',  src: 'pair-graph-active.png',      effect: 'pan-left' },
  { id: 6, dur: 10, type: 'image',  src: 'screenshot-sensors-live.png', effect: 'zoom-out' },
  { id: 7, dur: 5,  type: 'cta',    text: 'Full kit',                                    subtitle: '' },
  { id: 8, dur: 5,  type: 'end',    text: 'micro:bit\\nPlayground',                     subtitle: '' },
];
